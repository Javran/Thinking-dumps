...
Theorem app_assoc : forall A (l m n:list A),
  l ++ m ++ n = (l ++ m) ++ n.
Proof.
  intros A l m n. induction l as [|hl tl IHl].
  - reflexivity.
...
Proof.
  intros X l1 l2. induction l1 as [|h1 t1 IH].
  - reflexivity.
...
Theorem map_assoc_distr : forall (X Y : Type) (f : X -> Y) (l1 l2 : list X),
  map f (l1 ++ l2) = map f l1 ++ map f l2.
Proof.
  intros X Y f l1 l2. induction l1 as [|h1 t1 IH1].
  - reflexivity.
...
Proof.
  intros X Y f. induction l as [|h t IH].
  - reflexivity.
  - simpl. rewrite map_assoc_distr. rewrite IH. reflexivity.
Qed.
(** [] *)
