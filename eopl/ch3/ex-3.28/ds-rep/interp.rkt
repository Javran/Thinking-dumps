(module interp (lib "eopl.ss" "eopl")
  ...
  (require (only-in racket foldl remove-duplicates flatten remove))
...
;;;;;;;;;;;;;;;; the interpreter ;;;;;;;;;;;;;;;;
    ...
    (lambda (exp env)
      (cases expression exp
        ...
        (proc-exp (var body)
          (define free-vars
            (free-variables exp))
          (proc-val (procedure var body free-vars)))
  ...
  ; copied from my answer to ex 3.26
  ...
  (define apply-procedure
    ; now we need to pass in the environment
    ;   in order to evaluate free variables
    (lambda (proc1 val env)
      (cases proc proc1
        (procedure (var body free-vars)
          (define proc-env
            (foldl
              extend-env
              (init-env)
