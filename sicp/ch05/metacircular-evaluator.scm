...
(define (init-env)
  (let ((proc-list
         (list
          ...
          (mk-primitive-pair '< <)
          (mk-primitive-pair '<= <=)
          (mk-primitive-pair 'zero? zero?)
          (mk-primitive-pair 'eq? eq?)
          (mk-primitive-pair 'eqv? eqv?)
          (mk-primitive-pair 'car car)
          (mk-primitive-pair 'cdr cdr)
          (mk-primitive-pair 'cons cons)
          (mk-primitive-pair 'null? null?)
          (mk-primitive-pair 'list list)
          (mk-primitive-pair 'even? even?)
          (mk-primitive-pair 'odd? odd?)
          (mk-primitive-pair 'not not)
          (mk-primitive-pair 'remainder remainder)
          (mk-primitive-pair 'quotient quotient)
          (mk-primitive-pair 'sqrt sqrt)
          (mk-primitive-pair 'integer? integer?)
          (mk-primitive-pair 'member member)
          (mk-primitive-pair 'memq memq)
          (mk-primitive-pair 'delete delete)
          (mk-primitive-pair 'abs abs)
          (mk-primitive-pair 'append append)
          )))
    (extend-environment
     '(true false)
     '(#t   #f)
